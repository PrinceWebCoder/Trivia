...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgresql://prince@localhost:5432/trivia_test".format('localhost:5432', self.database_name)
    ...
    def test_422_cannot_create_question(self):
        ...
        self.assertEqual(data['message'], "Unprocessable. Syntax error.")
